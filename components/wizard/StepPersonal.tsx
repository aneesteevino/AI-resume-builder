...
const FIELDS: Field[] = [
  ...
  { key: "phone", label: "Phone Number", placeholder: "+92 301 00000000", type: "tel", required: true },
  { key: "location", label: "Location", placeholder: "Karachi, Pakistan", type: "text", required: true },
