...
export default function TemplatePrism({ data }: { data: ResumeData }) {
      ...
      case 'summary':
        ...
        return (
          <div key={id} className="mb-4">
            <h2 className="text-[11px] font-bold uppercase tracking-widest text-black border-b-2 border-blue-500/20 text-blue-600 normal-case tracking-wider mb-2 pb-0.5">
            ...
            <div className="space-y-3">
              {data.experience.map((exp, i) => (
                <div key={exp.id}>
                  ...
                  <div className="text-[10px] text-gray-600 leading-snug pl-3 relative whitespace-pre-wrap">
      ...
      case 'skills':
        ...
        return (
          <div key={id} className="mb-4">
            ...
            <div className="text-[10px] text-gray-600 leading-snug flex flex-wrap gap-x-1.5 gap-y-1">
  ...
  return (
    <div className="p-8 bg-white text-black font-sans" style={{ width: "100%", minHeight: "100%" }}>
      {/* Header */}
      <div className="mb-6 p-6 rounded-2xl text-white" style={{background: "linear-gradient(135deg, #3b82f6, #8b5cf6)"}}>
        ...
        <div className="text-[11px] text-white/90 flex flex-wrap gap-x-3 gap-y-1">
          ...
          {data.personal.phone && <><span className="text-white/40">•</span> <span><EditableText path="personal.phone" value={data.personal.phone} /></span></>}
          {data.personal.location && <><span className="text-white/40">•</span> <span><EditableText path="personal.location" value={data.personal.location} /></span></>}
          {data.personal.linkedin && <><span className="text-white/40">•</span> <span><EditableText path="personal.linkedin" value={data.personal.linkedin} /></span></>}
          {data.personal.github && <><span className="text-white/40">•</span> <span><EditableText path="personal.github" value={data.personal.github} /></span></>}
        </div>
      </div>
